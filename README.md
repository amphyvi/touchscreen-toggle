...
This will get you most of the way. Now, you can pin that EXE to your Start menu or taskbar, or create a shortcut to it, and you can now use it to toggle your touchscreen... **but, you must make it run as Administrator**.

If you don't mind the admin prompt, even if that means you may need to enter your password each time...
...
If you would rather it be as seamless as possible, and don't want the admin prompt each time... then follow these (kind of technical, but very helpful) steps: https://superuser.com/a/1854880

That's it! Now you can use the pin/shortcut you created, and even customize it with an icon etc, and you'll be able to quickly toggle your touchscreen on or off.
