...
### Using the EXE app
Run it like any other app, and it will toggle your touchscreen once each time you run it. Pin it to the taskbar or Start menu, create a desktop, whatever suits your workflow. However, you'll need to say Yes when the UAC prompt comes up.
